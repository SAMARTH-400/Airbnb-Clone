...
function Footer() {
    return (
        <footer classNameName="w-full mt-[120px]">
            <section className="py-10 bg-gray-100 sm:pt-16 lg:pt-24">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img className="w-auto h-20" src="/static/airbnbblue.svg" alt="" />

                <p className="text-base leading-relaxed text-gray-600 mt-">Airbnb is one of the world's largest travel marketplaces for both established brands and entrepreneurs.</p>
