...
function Footer() {
    return (
        <footer className="w-full mt-[120px]">
            <section class="py-10 bg-gray-100 sm:pt-16 lg:pt-24">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img class="w-auto h-9" src="/static/airbnb.svg" alt="" />

                <p class="text-base leading-relaxed text-gray-600 mt-7">Airbnb is one of the world's largest travel marketplaces for both established brands and entrepreneurs.</p>
