                        ...
                        <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 ">
                            <div className="mt-12">
                                <form method="post" action="/api/auth/signin/email">
                                    <div className="mb-5">
                                        <div className="text-sm font-bold text-gray-400 tracking-wide">Name</div>
                                        <input name="csrfToken" type="hidden" defaultValue={csrfToken} />
                                        <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-300 " type="text" id="name" name="name" ></input>
                                    </div>
                                    <div>
                                        <div className="text-sm font-bold text-gray-400 tracking-wide">Email Address</div>
                                        <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-300 " type="email" id="email" name="email" ></input>
                                    </div>
                                    <div className="mt-12">
                                        <button className="bg-[#8E56E8] text-gray-100 p-4 w-full rounded-full tracking-wide font-semibold font-display focus:outline-none focus:shadow-outline hover:bg-[#7C56E1] shadow-lg" type="submit">
                                            Log In
                                        </button>
                                    </div>
                                </form>
                            ...
                            <div className="mt-10">
                                <ul className="flex justify-between -mx-2 mb-12">
                                    <li className="px-2 w-full">
                                        <div className="flex h-11 button items-center justify-center rounded-full bg-[#D64937] hover:bg-opacity-90" onClick={() => signIn("google")}>
                                    ...
                                    <li className="px-2 w-full">
                                        <div className=" flex h-11 button items-center justify-center rounded-full bg-gray-700 hover:bg-opacity-90" onClick={() => signIn("facebook")}>
                                    ...
                                    <li className="px-2 w-full">
                                        <div className="flex h-11 button items-center justify-center rounded-full bg-[#1C9CEA] hover:bg-opacity-90" onClick={() => signIn("twitter")} >
