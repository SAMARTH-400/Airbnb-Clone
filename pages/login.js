                            ...
                            <div className="mt-10">
                                <ul className="flex justify-between -mx-2 mb-12">
                                    <li className="px-2 w-full">
                                        <div className="flex h-11 items-center justify-center rounded-full bg-[#D64937] hover:bg-opacity-90" onClick={() => signIn("google")}>
                                    ...
                                    <li className="px-2 w-full">
                                        <div className=" flex h-11 items-center justify-center rounded-full bg-gray-700 hover:bg-opacity-90" onClick={() => signIn("facebook")}>
